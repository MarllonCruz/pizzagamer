...
<head>
	...
	<title>Ghost Gamer - Videos</title>
			...
			<div class="nav-menu">
				...
				<div class="nav-menu--menus">
					<ul>
						...
						<li><a class="active" href="file:///C:/projetos/newsgames_v2/__MODELO/videos.html">VIDEOS</a></li>
					</ul>
				</div>
	...
	<main class="width-full">
		<section class="news-page container center">
			<div class="news-header">
				<h1>VIDEOS</h1>
				<p>Confira nossas videos e estar por dentro no mundo dos games</p>
